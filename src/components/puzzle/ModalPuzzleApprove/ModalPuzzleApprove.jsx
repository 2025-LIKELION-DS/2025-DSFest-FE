    ...
    <>
      ...
      {!state && (
        <B.ModalPuzzleSelect>
          ...
          <B.InputDiv>
            <InputCommon placeholder={"부스 비밀번호를 입력해주세요."} height="48px" value={value} onChange={onChange}/>
            {!right && (
              <B.Warning>
          ...
          <ButtonModalDual contentL={"QR코드 재인증"} onClickL={onClickL} contentR={"비밀번호 입력"} onClickR={onClickR}/>
      </B.ModalPuzzleSelect>
      )}
